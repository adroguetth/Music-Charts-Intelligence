...
Maps raw genre strings from various sources to standardized
(macro_genre, subgenre) tuples. Contains ~5000+ mappings covering
global, regional, and niche musical genres.
"""
...
# GENRE MAPPINGS
# =============================================================================
# Format: 'raw_genre_string': ('MacroGenre', 'Subgenre')
# The raw string is normalized (lowercase, stripped) before lookup.
