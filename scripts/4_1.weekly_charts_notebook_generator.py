...
Provide a DETAILED executive summary (10-12 lines) that:
    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                "temperature": 0.7,
                "max_tokens": 800 if section == "executive_summary" else 500
            },
            timeout=30
        )
...
# Load data - database is in root directory after copy
